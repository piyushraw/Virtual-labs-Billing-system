...
function update_invoice_totals() {
    ...
    $('input[name=invoice-total-amt-without-gst]').val(sum_amt_without_gst.toFixed(0));
    ...
    $('input[name=invoice-total-amt-sgst]').val(sum_amt_sgst.toFixed(0));
    ...
    $('input[name=invoice-total-amt-cgst]').val(sum_amt_cgst.toFixed(0));
    ...
    $('input[name=invoice-total-amt-igst]').val(sum_amt_igst.toFixed(0));

    sum_amt_with_gst = 0
    $('input[name=invoice-amt-with-gst]').each(function(){
        sum_amt_with_gst += parseFloat($(this).val());
    });
    $('input[name=invoice-total-amt-with-gst]').val(sum_amt_with_gst.toFixed(0));
